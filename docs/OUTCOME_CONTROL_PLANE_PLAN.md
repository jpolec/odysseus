...
| Evidence strength | Evaluation engine retains a heuristic signal; UI presents qualitative strength plus hard gates and unknowns | Partial | Internal legacy field remains `confidence`; no calibrated delivery probability exists | Add calibration datasets/curves before exposing probability | P2 |
